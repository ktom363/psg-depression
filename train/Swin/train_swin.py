...
# -*- coding: utf-8 -*-
"""
Swin Transformer training on PSG epoch images.
...
Outputs
-------
    <output-dir>/best_swin.pth             best-validation-loss checkpoint
...
LOGGER = logging.getLogger("train_swin")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Train a Swin Transformer on PSG epoch images produced "
    ...
    model.add_argument("--model-name", default="swin_base_patch4_window7_224",
...
def main(argv: Optional[Sequence[str]] = None) -> int:
    ...
    checkpoint_path = args.output_dir / "best_swin.pth"
